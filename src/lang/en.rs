...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the NT Connect network..."),
        ...
        ("install_tip", "Due to UAC, NT Connect can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install NT Connect to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant NT Connect \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant NT Connect \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow NT Connect to use the \"Accessibility\" service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next NT Connect application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant NT Connect \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant NT Connect \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running NT Connect."),
        ...
        ("verify_rustdesk_password_tip", "Verify NT Connect password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use NT Connect and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent NT Connect from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by NT Connect"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if NT Connect window is open"),
        ...
        ("floating_window_tip", "It helps to keep NT Connect background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the NT Connect client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, NT Connect verifies the server certificate for protocols using TLS.\nWith this option enabled, NT Connect will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, NT Connect will not use UDP 21116 any more, TCP 21116 will be used instead."),
